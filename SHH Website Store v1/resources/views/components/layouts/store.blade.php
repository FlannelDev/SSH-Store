...
<body class="min-h-screen bg-gray-950 text-gray-100 antialiased">
    ...
    <nav class="sticky top-0 z-50 border-b border-gray-800/60 bg-gray-950/80 backdrop-blur-xl">
        <div class="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
            <a href="{{ route('store') }}" class="flex items-center gap-3" wire:navigate>
            ...
            <div class="flex items-center gap-6">
                <a href="{{ route('store') }}" class="text-sm font-medium text-gray-300 transition hover:text-white" wire:navigate>
                    Game Servers
                </a>
