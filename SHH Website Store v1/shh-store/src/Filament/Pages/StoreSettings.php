...
class StoreSettings extends Page
{
    ...
    public function save(): void
    {
        ...
        config([
            'shh-store.stripe.key' => $state['stripe_key'] ?? '',
            'shh-store.stripe.secret' => $state['stripe_secret'] ?? '',
            'shh-store.stripe.webhook_secret' => $state['stripe_webhook_secret'] ?? '',
            'shh-store.paypal.client_id' => $state['paypal_client_id'] ?? '',
            'shh-store.paypal.client_secret' => $state['paypal_client_secret'] ?? '',
            'shh-store.paypal.mode' => $state['paypal_mode'] ?? 'sandbox',
        ]);
